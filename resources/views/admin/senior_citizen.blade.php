...
@section('main_content')
    ...
    <section class="content-header">
        <a href="#" data-toggle="modal" data-target="#modal-station">
            <button type="button" class="btn btn-success btn-sm">Add Kabataan</button>
        </a>

        <ol class="breadcrumb">
            <li><a href="{{ url('/home') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Blessed Youth</li>
        </ol>
    </section>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="civil_status" id="civil_status" class="form-control select2"  style="width: 100%;">
