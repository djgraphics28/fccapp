...
<div class="wrapper" id="app">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
      ...
      <span class="logo-mini" style="font-size:14px!important;"><b>FCC</b></span>
  ...
  <aside class="main-sidebar">
    ...
    <!-- /.sidebar -->
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2020 <a href="#">Free Christian Church Bugayong</a>.</strong> All rights
            reserved.
        </footer>
